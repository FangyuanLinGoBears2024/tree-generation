...
trees_order_16 = generate_non_isomorphic_trees(16)
trees_order_17 = generate_non_isomorphic_trees(17)


# Filter trees with exactly 7 leaves and no vertex of degree 2
trees_7_with_9_leaves = filter_trees_with_leaves_and_degree_constraint(trees_order_7, 9)
trees_8_with_9_leaves = filter_trees_with_leaves_and_degree_constraint(trees_order_8, 9)
trees_9_with_9_leaves = filter_trees_with_leaves_and_degree_constraint(trees_order_9, 9)
trees_10_with_9_leaves = filter_trees_with_leaves_and_degree_constraint(trees_order_10, 9)
trees_11_with_9_leaves = filter_trees_with_leaves_and_degree_constraint(trees_order_11, 9)
trees_12_with_9_leaves = filter_trees_with_leaves_and_degree_constraint(trees_order_12, 9)
trees_13_with_9_leaves = filter_trees_with_leaves_and_degree_constraint(trees_order_13, 9)
trees_14_with_9_leaves = filter_trees_with_leaves_and_degree_constraint(trees_order_14, 9)
trees_15_with_9_leaves = filter_trees_with_leaves_and_degree_constraint(trees_order_15, 9)
trees_16_with_9_leaves = filter_trees_with_leaves_and_degree_constraint(trees_order_16, 9)
trees_17_with_9_leaves = filter_trees_with_leaves_and_degree_constraint(trees_order_17, 9)

# Print the number of trees generated for each order
filtered_trees_count = {
    7: len(trees_7_with_9_leaves),
    8: len(trees_8_with_9_leaves),
    9: len(trees_9_with_9_leaves),
    10: len(trees_10_with_9_leaves),
    11: len(trees_11_with_9_leaves),
    12: len(trees_12_with_9_leaves),
    13: len(trees_13_with_9_leaves),
    14: len(trees_14_with_9_leaves),
    15: len(trees_15_with_9_leaves),
    16: len(trees_16_with_9_leaves),
    17: len(trees_17_with_9_leaves)
}

print("Number of non-isomorphic trees with 9 leaves for each order:")
for order, count in filtered_trees_count.items():
    print(f"Order {order}: {count} trees")

# Combine all trees to be checked
all_trees_with_9_leaves = (
    trees_7_with_9_leaves +
    trees_8_with_9_leaves +
    trees_9_with_9_leaves +
    trees_10_with_9_leaves +
    trees_11_with_9_leaves +
    trees_12_with_9_leaves +
    trees_13_with_9_leaves +
    trees_14_with_9_leaves +
    trees_15_with_9_leaves + 
    trees_16_with_9_leaves
)

# Find the first duplicate pair and stop immediately
first_duplicate = find_first_duplicate_pair(all_trees_with_9_leaves)
