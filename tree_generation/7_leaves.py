...
trees_7_with_7_leaves = filter_trees_with_leaves_and_degree_constraint(trees_order_7, 7)
trees_8_with_7_leaves = filter_trees_with_leaves_and_degree_constraint(trees_order_8, 7)
trees_9_with_7_leaves = filter_trees_with_leaves_and_degree_constraint(trees_order_9, 7)
trees_10_with_7_leaves = filter_trees_with_leaves_and_degree_constraint(trees_order_10, 7)
trees_11_with_7_leaves = filter_trees_with_leaves_and_degree_constraint(trees_order_11, 7)
trees_12_with_7_leaves = filter_trees_with_leaves_and_degree_constraint(trees_order_12, 7)
trees_13_with_7_leaves = filter_trees_with_leaves_and_degree_constraint(trees_order_13, 7)
trees_14_with_7_leaves = filter_trees_with_leaves_and_degree_constraint(trees_order_14, 7)
trees_15_with_7_leaves = filter_trees_with_leaves_and_degree_constraint(trees_order_15, 7)

# Print the number of trees generated for each order
filtered_trees_count = {
    7: len(trees_7_with_7_leaves),
    8: len(trees_8_with_7_leaves),
    9: len(trees_9_with_7_leaves),
    10: len(trees_10_with_7_leaves),
    11: len(trees_11_with_7_leaves),
    12: len(trees_12_with_7_leaves),
    13: len(trees_13_with_7_leaves),
    14: len(trees_14_with_7_leaves),
    15: len(trees_15_with_7_leaves),
}
...
all_trees_with_7_leaves = (
    trees_7_with_7_leaves +
    trees_8_with_7_leaves +
    trees_9_with_7_leaves +
    trees_10_with_7_leaves +
    trees_11_with_7_leaves +
    trees_12_with_7_leaves +
    trees_13_with_7_leaves +
    trees_14_with_7_leaves +
    trees_15_with_7_leaves
)

# Find the first duplicate pair and stop immediately
first_duplicate = find_first_duplicate_pair(all_trees_with_7_leaves)
